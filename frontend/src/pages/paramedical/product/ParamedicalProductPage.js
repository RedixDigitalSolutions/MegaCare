...
const products = [
    {
        ...
        stockQty: 5,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=800&fit=crop&q=80",
        shortDesc: "Fauteuil léger aluminium, poids 12 kg, dossier rabattable",
        deliveryDays: "3–5 jours",
        description: "Fauteuil roulant manuel ultra-léger en aluminium anodisé. Sa structure pliant facilite le transport et le rangement. Idéal pour un usage quotidien en intérieur et en extérieur.",
        usage: "Pour personnes à mobilité réduite, post-opératoire ou convalescence. Utilisation intérieur/extérieur sur sol plat ou légèrement incliné.",
        compatibility: "Cadre universel, largeur assise 45 cm. Capacité max 120 kg. Compatible accessoires standard VERMEIREN.",
        features: [
            "Poids net 12 kg",
    ...
    },
    {
        ...
        stockQty: 30,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1576671081837-49000212a370?w=800&fit=crop&q=80",
        shortDesc: "Mesure tensiométrique automatique, mémoire 60 mesures",
        deliveryDays: "24h",
        description: "Tensiomètre électronique de bras OMRON avec technologie IntelliSense pour une mesure précise. Mémoire de 60 mesures avec indicateur de tendance hypertension.",
        usage: "Utilisation au repos, après 5 minutes d'assise. Bras gauche à hauteur du cœur. Manchette 22–42 cm comprise.",
        compatibility: "Connexion Bluetooth compatible application OMRON Connect (iOS/Android). Manchette standard et M incluses.",
        features: [
    ...
    },
    {
        ...
        stockQty: 20,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&fit=crop&q=80",
        shortDesc: "Lecteur de glycémie rapide, résultat en 5 secondes",
        deliveryDays: "24h",
        description: "Le glucomètre AccuChek Active de Roche est un lecteur de glycémie capillaire fiable et simple d'utilisation. Résultat en 5 secondes avec une goutte de sang de 2 µl.",
        usage: "Piqûre au bout du doigt (ou site alternatif). Insérer la bandelette, appliquer la goutte. Ne dépasse pas l'usage autour des repas et à jeun.",
        compatibility: "Bandelettes AccuChek Active exclusivement. Autopiqueur AccuChek FastClix recommandé (vendu séparément).",
        features: [
    ...
    },
    {
        ...
        stockQty: 8,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1631815589968-fdb09a223b1e?w=800&fit=crop&q=80",
        shortDesc: "Rollator léger aluminium, panier de rangement, hauteur réglable",
        deliveryDays: "3–5 jours",
        description: "Rollator 4 roues en aluminium léger avec siège intégré. Idéal pour les personnes à mobilité réduite souhaitant se déplacer en autonomie. Pliable pour le transport.",
        usage: "Déplacements intérieur/extérieur. Régler la hauteur des poignées selon la morphologie. Ne pas dépasser 130 kg.",
        compatibility: "Accessoires Drive Medical compatibles. Sac de rangement universel 30L inclus.",
        features: [
    ...
    },
    {
        ...
        stockQty: 50,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800&fit=crop&q=80",
        shortDesc: "Maintien cervical confort, mousse polyuréthane, taille M",
        deliveryDays: "24h",
        description: "Collier cervical souple THUASNE en mousse polyuréthane à mémoire de forme. Maintien discret adapté aux contractures musculaires, torticolis et douleurs légères.",
        usage: "Porter quelques heures par jour selon prescription. Ne pas utiliser en conduite. Hauteur 7,5 cm taille M.",
    ...
    },
    {
        ...
        stockQty: 25,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1550572017-ea058ca87258?w=800&fit=crop&q=80",
        shortDesc: "Genouillère renforcée, baleines bilatérales, taille S–XL",
        deliveryDays: "48h",
        description: "Genouillère ligamentaire GIBAUD avec baleines bilatérales et rotulienne. Tissage compressif pour stabilisation et drainage lors d'activités sportives ou de rééducation.",
        usage: "Entorse, instabilité ligamentaire, gonalgie légère. Sport ou usage quotidien. Enfiler à froid, retirer en cas de douleur accrue.",
        compatibility: "Taille S à XL selon périmètre genoux. Tableau des tailles inclus.",
        features: [
    ...
    },
    {
        ...
        stockQty: 40,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=800&fit=crop&q=80",
        shortDesc: "Mesure SpO2 et fréquence cardiaque, écran LED, piles incluses",
        deliveryDays: "24h",
        description: "Oxymètre de pouls BEURER à pince pour mesure non invasive de la saturation en oxygène (SpO2) et de la fréquence cardiaque. Idéal pour surveillance à domicile.",
        usage: "Installer sur index ou majeur propre et sec. Rester immobile pendant 10 secondes. Ne pas utiliser en remplacement d'un diagnostic médical.",
        compatibility: "Piles AAA × 2 incluses. Compatible doigts adultes 7–25 mm. Étui de transport inclus.",
        features: [
    ...
    },
    {
        ...
        stockQty: 100,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800&fit=crop&q=80",
        shortDesc: "Pansements hypoallergéniques toutes tailles, emballage stérile",
        deliveryDays: "24h",
        description: "Assortiment de pansements stériles Hartmann Cosmopor en 4 formats. Coussin absorbant non adhérent, bords renforcés, hypoallergéniques. Usage plaies superficielles.",
        usage: "Nettoyer et sécher la plaie. Appliquer sans tension sur peau sèche. Changer toutes les 24h ou si souillé.",
        compatibility: "20 pansements : 4×5 formats différents 5×7 cm, 7×10 cm, 9×15 cm, 9×20 cm.",
        features: [
    ...
    },
    {
        ...
        stockQty: 80,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=800&fit=crop&q=80",
        shortDesc: "Compresses 10×10 cm, non pelucheuses, lot de 100",
        deliveryDays: "24h",
        description: "Compresses stériles non-tissées Hartmann en viscose / polyester. Non pelucheuses, assurent une absorption efficace. Conditionnées par 5 en pochette individuelle.",
        usage: "Nettoyage de plaies, protection post-opératoire, pansements. Usage unique, ne pas réutiliser.",
        compatibility: "10 × 10 cm. 100 compresses en 20 sachets de 5. Stérilisation EO.",
        features: [
            "100% non pelucheuses",
            "Viscose + polyester",
    ...
    },
    {
        ...
        stockQty: 18,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=800&fit=crop&q=80",
        shortDesc: "Mesure auriculaire en 1 seconde, 9 positions mémoire",
        deliveryDays: "24h",
        description: "Thermomètre auriculaire Braun ThermoScan 5 avec technologie ExactTemp. Mesure précise en 1 seconde. Embouts Lens Filter jetables garantissent hygiène optimale.",
        usage: "Insérer dans le conduit auditif. Appuyer sur le bouton jusqu'au signal sonore (1 seconde). Utiliser un embout propre par mesure.",
        compatibility: "Embouts LF 40 compatibles (disponibles séparément). Piles AA × 2 incluses.",
        features: [
            "Mesure en 1 seconde",
    ...
    },
    {
        ...
        stockQty: 12,
        prescription: true,
        imageUrl: "https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=800&fit=crop&q=80",
        shortDesc: "Mousse viscoélastique mémoire de forme, diamètre 40 cm",
        deliveryDays: "48h",
        description: "Coussin anti-escarres en mousse viscoélastique à mémoire de forme. Répartit la pression et améliore la circulation sanguine pour les patients assis prolongés.",
        usage: "À poser sur siège de fauteuil roulant, chaise ou voiture. Utilisation sur prescription médicale recommandée.",
        compatibility: "Diamètre 40 cm, hauteur 5 cm. Housse déhoussable lavable 40°C.",
        features: [
    ...
    },
    {
        ...
        deliveryDays: "48h",
        description: "Semelles orthopédiques sport Bauerfeind avec gel amortisseur au talon et métatarse. Soutien voûte plantaire et correction légère de la pronation.",
        usage: "Insérer dans chaussures de sport ou marche. Taille sur semelle d'origine. Durée de vie ~12 mois d'usage régulier.",
        compatibility: "Tailles 36 à 46. Découpage selon gabarit. Compatible chaussures standard ≥ 6 mm de profondeur.",
        features: [
    ...
    },
    {
        ...
        deliveryDays: "24h",
        description: "Bandes de contention élastiques Sigvaris pour maintien des entorses et pansements compressifs. Extensibles, elles épousent parfaitement la morphologie.",
        usage: "Bandage à froid après entorse. Poser sans excès de pression. Retirer si douleur ou engourdissement.",
        compatibility: "10 cm × 4 m étiré. Lot de 2 bandes. Lavable 30°C, réutilisable.",
        features: [
            "10 cm × 4 m étiré",
            "Extensibilité 150%",
            "Lot de 2 bandes",
    ...
    },
    {
        ...
        deliveryDays: "24h",
        description: "Bandelettes glycémie originals Roche pour lecteur AccuChek Active. Technologie PhotoSense pour résultats précis sans codage. Boîte de 50 unités.",
        usage: "Insérer la bandelette dans le lecteur. Appliquer 2 µL de sang capillaire. Résultat en 5 secondes. Jeter après usage.",
        compatibility: "Compatibles lecteurs AccuChek Active uniquement. Conserver < 25°C, humidité < 85%.",
        features: [
    ...
    },
    {
        ...
        deliveryDays: "24h",
        description: "Lancettes BD Ultra-Fine 28G pour autopiqueur. Biseau triple affûtage pour perforation moins douloureuse. Stérilisées en ETO, conditionnées individuellement.",
        usage: "Utiliser avec autopiqueur BD (ou universel). Un usage unique. Mettre dans conteneur DASRI après usage.",
        compatibility: "Compatibles majorité des autopiqueurs du marché (universels). 28 Gauge, longueur 1,8 mm.",
        features: [
    ...
    },
    {
        ...
        deliveryDays: "3–5 jours",
        description: "Tire-lait électrique double Medela Swing Maxi avec technologie 2-Phase Expression imitant la succion naturelle du bébé. Utilisation mains libres avec bustier dédié.",
        usage: "Brancher les tétines selon taille (S/M/L). Régler l'aspiration progressivement. Séance 15–20 mn. Stériliser les pièces après chaque usage.",
        compatibility: "Bustier mains libres Medela requis (vendu séparément). Universel seins 21–30 mm. Cordon secteur inclus.",
        features: [
    ...
    },
    {
        ...
        deliveryDays: "48h",
        description: "Ballon de gym/rééducation Gymnic Pastorelli anti-éclatement. Utilisé en kinésithérapie, renforcement musculaire, grossesse et yoga. Diamètre 65 cm pour taille 160–175 cm.",
        usage: "Gonfler à pression modérée. Ne pas exposer à la chaleur. Utilisable surface plane non abrasive. Capacité 300 kg.",
        compatibility: "Pour utilisateurs 160–175 cm. Pompe manuelle incluse. PVC sans phtalates.",
        features: [
            "Diamètre 65 cm",
            "Anti-éclatement ABS",
            "Capacité 300 kg",
    ...
    },
    {
        ...
        deliveryDays: "24h",
        description: "Bande de résistance Thera-Band pour rééducation et renforcement musculaire. Latex naturel, 1,5 m × 15 cm. Disponible en 5 niveaux de résistance (jaune à bleu).",
        usage: "Ancrer à un support fixe ou utiliser avec les mains. Progression de la résistance par couleur. Rincer à l'eau froide après usage.",
        compatibility: "1,5 m × 15 cm. Choisir la couleur/résistance selon niveau : jaune (faible) → bleu (forte).",
        features: [
            "5 niveaux couleur",
    ...
    },
    {
        ...
        stockQty: 0,
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&fit=crop&q=80",
        shortDesc: "Béquilles axillaires léger aluminium, hauteur 1.10–1.50 m",
        deliveryDays: "7–10 jours",
        description: "Paire de béquilles axillaires Invacare en aluminium léger. Hauteur réglable pour utilisateurs de 1,10 à 1,50 m. Embout axillaire rembourré, poignée ergonomique.",
        usage: "Régler la hauteur avant utilisation. Poser la béquille 5 cm à l'extérieur du pied. Appui sur la poignée, pas l'aisselle.",
        compatibility: "Paire. Hauteur réglable 1,10–1,50 m. Capacité 100 kg. Embout pavé 30 mm.",
        features: [
    ...
    },
    {
        ...
        prescription: false,
        imageUrl: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&fit=crop&q=80",
        shortDesc: "Aérosol à compresseur < 45 dB, embout buccal + masques adulte & enfant",
        deliveryDays: "48h",
        description: "Nébuliseur OMRON A3 Complete à compresseur silencieux. Convient aux maladies respiratoires : asthme, bronchite, BPCO. Technologie V.V.T pour traitement efficace.",
        usage: "Remplir le nébuliseur selon prescription. Utiliser masque ou embout buccal. Séance 10–15 mn. Rincer et sécher après usage.",
        compatibility: "Médicaments en solution aqueuse (prescrits). Kit complet : embout buccal, masque adulte, masque enfant, filtre.",
        features: [
