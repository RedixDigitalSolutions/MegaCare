    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <Link to="/transport-dashboard/trips" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
          ...
          <Link to="/transport-dashboard/vehicles" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
          ...
          <Link to="#" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">👥</div>
