...
import { Users, Calendar, Clock, TrendingUp, CalendarDays, ClipboardList, UserCircle, FileHeart, Activity, Video, MessageSquare, Bell, Map, Package, BarChart3, CheckCircle2, ClipboardCheck, CreditCard, AlertCircle, ArrowRight, } from "lucide-react";
...
export default function ParamedicalDashboardPage() {
    ...
    return (_jsxs("div", { className: "flex min-h-screen bg-background", children: [_jsx(ParamedicalDashboardSidebar, {}), _jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [_jsx("div", { className: "px-6 py-5 border-b border-border bg-card/50 shrink-0", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs("h1", { className: "text-xl font-bold text-foreground", children: ["Bonjour, ", user.firstName, " \uD83D\uDC4B"] }), _jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Tableau de bord \u2014 Param\u00E9dical" })] }), _jsxs(Link, { to: "/paramedical-dashboard/planning", className: "hidden sm:flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition", children: [_jsx(CalendarDays, { size: 15 }), "Voir le planning"] })] }) }), _jsxs("main", { className: "flex-1 overflow-y-auto p-6 space-y-6", children: [_jsx("div", { className: "grid grid-cols-2 xl:grid-cols-4 gap-4", children: kpis.map((kpi) => {
                                    const Icon = kpi.icon;
                                    return (_jsxs("div", { className: "bg-card rounded-xl border border-border p-4 space-y-3", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("p", { className: "text-xs font-medium text-muted-foreground leading-tight", children: kpi.label }), _jsx("div", { className: `w-8 h-8 rounded-lg flex items-center justify-center ${kpi.bg}`, children: _jsx(Icon, { size: 16, className: kpi.color }) })] }), _jsx("p", { className: "text-2xl font-bold text-foreground", children: kpi.value }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsx("span", { className: "text-xs text-muted-foreground", children: kpi.sub }), _jsx("span", { className: `text-xs font-medium ${kpi.trendColor}`, children: kpi.trend })] })] }, kpi.label));
                                }) }), _jsxs("div", { children: [_jsx("h2", { className: "text-sm font-semibold text-foreground mb-3", children: "Acc\u00E8s rapide" }), _jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3", children: quickLinks.map((q) => {
                                            const Icon = q.icon;
                                            return (_jsxs(Link, { to: q.href, className: "bg-card rounded-xl border border-border p-4 hover:shadow-md hover:border-primary/40 transition-all group space-y-2", children: [_jsx("div", { className: `w-9 h-9 rounded-lg flex items-center justify-center ${q.bg}`, children: _jsx(Icon, { size: 18, className: q.color }) }), _jsx("p", { className: "text-sm font-semibold text-foreground group-hover:text-primary transition leading-tight", children: q.label }), _jsx("p", { className: "text-xs text-muted-foreground leading-tight", children: q.desc })] }, q.href));
                                        }) })] }), _jsxs("div", { className: "bg-card rounded-xl border border-border overflow-hidden", children: [_jsxs("div", { className: "px-5 py-4 border-b border-border flex items-center justify-between", children: [_jsx("h2", { className: "font-semibold text-foreground text-sm", children: "Activit\u00E9 r\u00E9cente" }), _jsxs(Link, { to: "/paramedical-dashboard/reports", className: "text-xs text-primary hover:underline flex items-center gap-1", children: ["Voir rapports ", _jsx(ArrowRight, { size: 12 })] })] }), _jsx("div", { className: "divide-y divide-border", children: activities.map((a, i) => {
                                            const Icon = a.icon;
                                            return (_jsxs("div", { className: "flex items-center gap-4 px-5 py-3.5", children: [_jsx("div", { className: `w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${a.bg}`, children: _jsx(Icon, { size: 15, className: a.color }) }), _jsx("div", { className: "flex-1 min-w-0", children: _jsx("p", { className: "text-sm text-foreground truncate", children: a.text }) }), _jsx("span", { className: "text-xs text-muted-foreground shrink-0", children: a.time })] }, i));
                                        }) })] })] })] })] }));
}
