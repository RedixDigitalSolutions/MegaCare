        ...
        <main className="flex-1 overflow-auto">
          <div className="p-6 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground mt-2">Historique et suivi de vos commandes</p>
            </div>

            <div className="space-y-4">
              {orders.map((order) => (
                <div key={order.id} className={`border-2 rounded-lg p-6 ${getStatusColor(order.status)}`}>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{order.date} • {order.pharmacy}</p>
                        </div>
                      </div>
