      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Social Links */}
            <div className="flex gap-3">
              <SocialLink href="#" label="Facebook"><FaFacebook className="w-5 h-5" /></SocialLink>
              <SocialLink href="#" label="Instagram"><FaInstagram className="w-5 h-5" /></SocialLink>
              <SocialLink href="#" label="LinkedIn"><FaLinkedinIn className="w-5 h-5" /></SocialLink>
              <SocialLink href="#" label="Twitter/X"><FaXTwitter className="w-5 h-5" /></SocialLink>
              <SocialLink href="#" label="YouTube"><FaYoutube className="w-5 h-5" /></SocialLink>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            >
              ...
              <FaExternalLinkAlt size={10} className="opacity-60 group-hover:opacity-100 transition-opacity duration-300" />
            </a>
