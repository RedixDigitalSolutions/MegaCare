...
const establishments = [
    {
        ...
        accredited: true,
        emergencies: true,
        imageUrl: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=1200&fit=crop&q=80",
        gallery: [
        ...
        team: [
            {
                ...
                image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&fit=crop&q=80",
            },
            {
                name: "Dr Karim Trabelsi",
                specialty: "Chirurgie générale",
                image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&fit=crop&q=80",
            },
            {
                name: "Dr Fatima Chérif",
                specialty: "Gynécologie-Obstétrique",
                image: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=200&fit=crop&q=80",
            },
            {
                name: "Dr Riadh Hamrouni",
                specialty: "Neurologie",
                image: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=200&fit=crop&q=80",
            },
        ],
        patientReviews: [
            {
                author: "Sonia M.",
                rating: 5,
                comment: "Personnel extrêmement professionnel. Mon intervention chirurgicale s'est parfaitement déroulée et le suivi post-op était irréprochable.",
                date: "Mars 2026",
            },
            {
                author: "Ahmed B.",
                rating: 5,
                comment: "Les urgences sont réactives, j'ai été pris en charge en moins de 10 minutes. Matériel moderne et équipe compétente.",
                date: "Fév 2026",
            },
            {
                author: "Leïla K.",
                rating: 4,
                comment: "Très bonne clinique, excellent service de cardiologie. Légère attente à l'accueil mais rien d'alarmant.",
                date: "Jan 2026",
            },
            {
                author: "Mohamed T.",
                rating: 5,
                comment: "La maternité est au top. Ma femme a accouché dans les meilleures conditions. On recommande vivement!",
                date: "Déc 2025",
            },
        ],
    },
    {
        ...
        accredited: true,
        emergencies: true,
        imageUrl: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1200&fit=crop&q=80",
        description: "Grand hôpital public universitaire fondé en 1949, l'Hôpital Aziza Othmana est l'un des plus anciens et des plus importants établissements de santé de Tunis. Il offre des soins de qualité dans 15 services spécialisés, avec des conventions CNAM permettant une prise en charge intégrale. L'hôpital forme également des médecins résidents en collaboration avec la Faculté de Médecine de Tunis.",
        beds: 450,
        doctors: 280,
        founded: 1949,
        schedule: [
        ...
        team: [
            {
                ...
                image: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&fit=crop&q=80",
            },
            {
                name: "Dr Wafa Jlassi",
                specialty: "Pédiatrie",
                image: "https://images.unsplash.com/photo-1651008376811-b90baee60c1f?w=200&fit=crop&q=80",
            },
        ],
        patientReviews: [
            {
                author: "Rim A.",
                rating: 4,
                comment: "Bon suivi médical, personnel dévoué. La prise en charge CNAM est parfaite.",
                date: "Fév 2026",
            },
            {
                author: "Sofien B.",
                rating: 4,
                comment: "Service des urgences efficace. Quelques attentes mais inévitables dans un hôpital public.",
                date: "Jan 2026",
            },
        ],
    },
    {
        ...
        accredited: true,
        emergencies: false,
        imageUrl: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=1200&fit=crop&q=80",
        description: "Centre multi-spécialités d'excellence au cœur des Berges du Lac, ouvert en 2012. Ses équipements de dernière génération incluant un IRM 3T, un scanner 128 coupes et un plateau d'imagerie complet en font une référence pour le diagnostic et le suivi ambulatoire.",
        beds: 0,
        doctors: 45,
        founded: 2012,
        schedule: [
        ...
        team: [
            {
                ...
                image: "https://images.unsplash.com/photo-1614608682850-e0d6ed316d47?w=200&fit=crop&q=80",
            },
            {
        ...
        patientReviews: [
            {
                author: "Lina T.",
                rating: 5,
                comment: "Centre magnifique, équipements top de gamme. Prise en charge rapide et médecins à l'écoute.",
                date: "Mars 2026",
            },
            {
                author: "Youssef K.",
                rating: 5,
                comment: "IRM réalisée dans les 48h, résultats en ligne le lendemain. Service impeccable!",
                date: "Fév 2026",
            },
        ],
    },
    {
        ...
        accredited: true,
        emergencies: true,
        imageUrl: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1200&fit=crop&q=80",
        description: "Clinique pluridisciplinaire au nord de Tunis offrant chirurgie mini-invasive, soins de rééducation et consultations spécialisées depuis 2003.",
        beds: 120,
        doctors: 80,
        founded: 2003,
        schedule: [
        ...
        patientReviews: [
            {
                author: "Ines B.",
                rating: 5,
                comment: "Excellent service orthopédique, chirurgien très compétent. Rétablissement parfait.",
                date: "Jan 2026",
            },
        ],
    },
    {
        ...
        accredited: true,
        emergencies: false,
        imageUrl: "https://images.unsplash.com/photo-1631815589968-fdb09a223b1e?w=1200&fit=crop&q=80",
        description: "Premier réseau d'hospitalisation à domicile à Sfax, opérationnel depuis 2018. Des équipes soignantes qualifiées se déplacent chez vous 7j/7.",
        beds: 0,
        doctors: 22,
        founded: 2018,
        schedule: [
        ...
        patientReviews: [
            {
                author: "Khaled M.",
                rating: 5,
                comment: "Service HAD exceptionnel. Les infirmières sont ponctuelles, professionnelles et très attentionnées.",
                date: "Mars 2026",
            },
        ],
    },
    {
        ...
        accredited: true,
        emergencies: true,
        imageUrl: "https://images.unsplash.com/photo-1599045118108-bf9954418b76?w=1200&fit=crop&q=80",
        description: "Principale clinique privée du Sahel depuis 1989, offrant une gamme complète de services médicaux et chirurgicaux.",
        beds: 200,
        doctors: 95,
        founded: 1989,
        schedule: [
    ...
    },
    {
        ...
        accredited: false,
        emergencies: false,
        imageUrl: "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=1200&fit=crop&q=80",
        description: "Centre de santé accessible offrant consultations de médecine générale et spécialisée avec des tarifs conventionnés CNAM.",
        beds: 0,
        doctors: 18,
        founded: 2008,
        schedule: [
    ...
    },
    {
        ...
        accredited: true,
        emergencies: true,
        imageUrl: "https://images.unsplash.com/photo-1536064479547-7ee40b74b807?w=1200&fit=crop&q=80",
        description: "Centre hospitalier universitaire régional desservant le Sahel. 800 lits, 20 services spécialisés.",
        beds: 800,
        doctors: 380,
        founded: 1983,
    ...
    },
    {
        ...
        accredited: true,
        emergencies: true,
        imageUrl: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=1200&fit=crop&q=80",
        description: "Principale clinique privée de la région nord, offrant maternité, chirurgie programmée et urgences médicales.",
        beds: 90,
        doctors: 55,
        founded: 2007,
        schedule: [
