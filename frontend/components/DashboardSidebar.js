...
export function DashboardSidebar({ userName = "Patient", liveDoctorName, }) {
    ...
    const NavContent = () => (_jsxs(_Fragment, { children: [_jsxs("div", { className: "flex items-center gap-3 px-5 py-5 border-b border-sidebar-border shrink-0", children: [_jsx("div", { className: "w-9 h-9 bg-sidebar-primary/20 rounded-xl flex items-center justify-center", children: _jsx(Heart, { size: 17, className: "text-sidebar-primary" }) }), _jsxs("span", { className: "font-bold text-lg text-sidebar-foreground tracking-tight", children: ["MEGA", _jsx("span", { className: "text-sidebar-primary", children: "CARE" })] })] }), _jsx("div", { className: "px-4 py-3 border-b border-sidebar-border shrink-0", children: _jsxs("div", { className: "flex items-center gap-3 px-3 py-2.5 rounded-xl bg-sidebar-accent/40", children: [_jsxs("div", { className: "relative shrink-0", children: [_jsx("div", { className: "w-9 h-9 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-xs font-bold text-white", children: initials }), _jsx("span", { className: "absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-emerald-400 border-2 border-sidebar" })] }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "font-semibold text-sm text-sidebar-foreground truncate", children: displayName }), _jsx("p", { className: "text-xs text-sidebar-foreground/50", children: "Patient" })] })] }) }), _jsxs("nav", { className: "flex-1 overflow-y-auto px-3 py-3 space-y-0.5", children: [liveDoctorName && (_jsxs(Link, { to: "/dashboard/live-consultation", onClick: () => setMobileOpen(false), className: `flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-sm ${pathname === "/dashboard/live-consultation"
                        ...
                        return (_jsxs(Link, { to: item.href, onClick: () => setMobileOpen(false), className: `flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-sm ${isActive
                                ...
                                : "text-sidebar-foreground/60 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground"}`, children: [_jsx(Icon, { size: 17, className: isActive ? "text-sidebar-primary" : "" }), _jsx("span", { className: "flex-1", children: item.label }), item.badge !== undefined && (_jsx("span", { className: `text-[10px] font-bold px-1.5 py-0.5 rounded-full ${typeof item.badge === "string"
                                        ? "bg-amber-400/20 text-amber-400"
                                        : "bg-destructive text-white"}`, children: item.badge }))] }, item.href));
