                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Consultations vidéo, ordonnances, pharmacie & dossier
                        médical
                      </p>
                    </div>
                    <FaArrowRight
                      className="shrink-0 text-muted-foreground/30 group-hover:text-blue-500 group-hover:translate-x-1 transition-all duration-300"
                      size={15}
                    />
                  </div>
                </button>
