            ...
            <div className="lg:col-span-2 space-y-4">
              {cartItems.length === 0 ? (
                <div className="bg-card border border-border rounded-lg p-12 text-center space-y-4">
                  ...
                  <Link to="/pharmacy" className="text-primary hover:underline">Continuer vos achats</Link>
                </div>
              ) : (
                cartItems.map((item) => (
            ...
            {cartItems.length > 0 && (
              <div className="space-y-4">
                <div className="bg-card border border-border rounded-lg p-6 space-y-4">
                  ...
                  <Link to="/pharmacy/checkout" className="block w-full bg-primary text-primary-foreground py-3 rounded-lg font-semibold hover:bg-primary/90 transition text-center">
                    Passer la commande
                  </Link>
