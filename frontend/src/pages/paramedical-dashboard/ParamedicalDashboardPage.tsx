    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          <Link to="/paramedical-dashboard/planning" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
          ...
          <Link to="/paramedical-dashboard/patients" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">👥</div>
          ...
          <Link to="/paramedical-dashboard/care-record" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">📋</div>
          ...
          <Link to="/paramedical-dashboard/vitals" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
          ...
          <Link to="/paramedical-dashboard/teleconsultation" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">📹</div>
          ...
          <Link to="/paramedical-dashboard/messaging" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">💬</div>
          ...
          <Link to="/paramedical-dashboard/supplies" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">📦</div>
          ...
          <Link to="/paramedical-dashboard/reports" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">📊</div>
          ...
          <Link to="/paramedical-dashboard/map" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">🗺️</div>
          ...
          <Link to="/paramedical-dashboard/notifications" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">🔔</div>
          ...
          <Link to="/paramedical-dashboard/settings" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-3">
            <div className="text-3xl">⚙️</div>
