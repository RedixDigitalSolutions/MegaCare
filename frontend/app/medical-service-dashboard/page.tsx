    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <Link href="/medical-service-dashboard/patients" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
          ...
          <Link href="/medical-service-dashboard/team" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
          ...
          <Link href="/medical-service-dashboard/schedule" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">📅</div>
          ...
          <Link href="/medical-service-dashboard/prescriptions" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">💊</div>
          ...
          <Link href="/medical-service-dashboard/teleconsultation" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">📹</div>
          ...
          <Link href="/medical-service-dashboard/vitals" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">❤️</div>
          ...
          <Link href="/medical-service-dashboard/equipment" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">🏥</div>
          ...
          <Link href="/medical-service-dashboard/billing" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">💳</div>
          ...
          <Link href="/medical-service-dashboard/messaging" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">💬</div>
          ...
          <Link href="/medical-service-dashboard/analytics" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">📊</div>
          ...
          <Link href="/medical-service-dashboard/settings" className="bg-card rounded-xl border border-border p-6 hover:shadow-lg transition space-y-4">
            <div className="text-3xl">⚙️</div>
