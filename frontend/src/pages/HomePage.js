...
import { Star, Shield, Clock, CheckCircle, Zap, ArrowRight, Play, Heart, Stethoscope, Pill, Brain, Eye, Bone, Baby, Activity, Sparkles, Video, FileText, Users, Award, TrendingUp, MousePointer, ChevronRight, X, } from "lucide-react";
export default function HomePage() {
    return (_jsxs("div", { className: "min-h-screen bg-background flex flex-col overflow-x-hidden", children: [_jsx(Header, {}), _jsxs("main", { className: "flex-1", children: [_jsx(HeroSection, {}), _jsx(PartnersSection, {}), _jsx(StatsSection, {}), _jsx(ServicesSection, {}), _jsx(SpecialtiesSection, {}), _jsx(FeaturesSection, {}), _jsx(HowItWorksSection, {}), _jsx(TestimonialsSection, {}), _jsx(AppShowcaseSection, {}), _jsx(CTASection, {})] }), _jsx(Footer, {})] }));
}
...
function AppShowcaseSection() {
    const { ref, isInView } = useInView();
    return (_jsx("section", { ref: ref, className: "py-24 bg-gradient-to-b from-secondary/30 to-background relative overflow-hidden", children: _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [_jsxs("div", { className: `space-y-8 transition-all duration-700 ${isInView
                            ? "opacity-100 translate-x-0"
                            : "opacity-0 -translate-x-12"}`, children: [_jsx("span", { className: "inline-block px-4 py-2 bg-accent/10 text-accent rounded-full text-sm font-semibold", children: "Application Mobile" }), _jsxs("h2", { className: "text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground text-balance", children: ["MegaCare dans", _jsx("span", { className: "gradient-text", children: " votre poche" })] }), _jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: "Telechargez notre application mobile pour acceder a tous nos services ou que vous soyez. Disponible sur iOS et Android." }), _jsx("ul", { className: "space-y-4", children: [
                                    "Notifications en temps reel",
                                    "Chat avec votre medecin",
                                    "Rappels de medicaments",
                                    "Suivi de sante personnalise",
                                ].map((feature, i) => (_jsxs("li", { className: `flex items-center gap-3 transition-all duration-500 ${isInView
                                        ? "opacity-100 translate-x-0"
                                        : "opacity-0 -translate-x-8"}`, style: { transitionDelay: `${300 + i * 100}ms` }, children: [_jsx("div", { className: "w-6 h-6 rounded-full bg-accent/20 flex items-center justify-center", children: _jsx(CheckCircle, { size: 14, className: "text-accent" }) }), _jsx("span", { className: "text-foreground font-medium", children: feature })] }, i))) }), _jsxs("div", { className: "flex flex-wrap gap-4 pt-4", children: [_jsxs("button", { className: "group flex items-center gap-3 px-6 py-3 bg-foreground text-background rounded-2xl font-semibold hover:scale-105 transition-all duration-300", children: [_jsx("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" }) }), _jsxs("div", { className: "text-left", children: [_jsx("p", { className: "text-[10px] opacity-80", children: "Telecharger sur" }), _jsx("p", { className: "text-sm font-bold -mt-0.5", children: "App Store" })] })] }), _jsxs("button", { className: "group flex items-center gap-3 px-6 py-3 bg-foreground text-background rounded-2xl font-semibold hover:scale-105 transition-all duration-300", children: [_jsx("svg", { className: "w-8 h-8", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.198l2.807 1.626a1 1 0 010 1.73l-2.808 1.626L15.206 12l2.492-2.491zM5.864 2.658L16.802 8.99l-2.303 2.303-8.635-8.635z" }) }), _jsxs("div", { className: "text-left", children: [_jsx("p", { className: "text-[10px] opacity-80", children: "Disponible sur" }), _jsx("p", { className: "text-sm font-bold -mt-0.5", children: "Google Play" })] })] })] })] }), _jsx("div", { className: `relative transition-all duration-700 delay-300 ${isInView
                            ? "opacity-100 translate-x-0"
                            : "opacity-0 translate-x-12"}`, children: _jsxs("div", { className: "relative flex justify-center", children: [_jsx("div", { className: "absolute w-80 h-80 bg-gradient-to-br from-primary/30 to-accent/30 rounded-full blur-[100px]" }), _jsx("div", { className: "relative glass rounded-[3rem] p-3 shadow-2xl border border-white/20", children: _jsx("div", { className: "w-64 h-[500px] bg-gradient-to-br from-primary to-accent rounded-[2.5rem] flex items-center justify-center overflow-hidden", children: _jsxs("div", { className: "text-center text-primary-foreground p-6", children: [_jsx("div", { className: "w-24 h-24 mx-auto mb-6 bg-white/20 rounded-3xl flex items-center justify-center", children: _jsx("img", { src: "/images/logo.png", alt: "MegaCare App", width: 60, height: 60, className: "object-contain" }) }), _jsx("h3", { className: "text-2xl font-bold mb-2", children: "MegaCare" }), _jsx("p", { className: "text-sm opacity-80", children: "Votre sante, connectee" })] }) }) }), _jsx("div", { className: "absolute -left-8 top-1/4 glass p-3 rounded-2xl shadow-lg animate-float", children: _jsx(TrendingUp, { size: 24, className: "text-green-500" }) }), _jsx("div", { className: "absolute -right-8 top-1/3 glass p-3 rounded-2xl shadow-lg animate-float delay-500", children: _jsx(Heart, { size: 24, className: "text-red-500" }) }), _jsx("div", { className: "absolute -right-4 bottom-1/4 glass p-3 rounded-2xl shadow-lg animate-float delay-300", children: _jsx(Pill, { size: 24, className: "text-accent" }) })] }) })] }) }) }));
}
// CTA Section
function CTASection() {
    const { ref, isInView } = useInView();
