...
export function DoctorCard({
  ...
  return (
    <Link href={`/doctor/${id}`}>
      <div className="group bg-card rounded-xl border border-border overflow-hidden hover:shadow-xl hover:border-primary/30 transition duration-300 cursor-pointer">
