...
export const metadata = {
  title: "Politique de confidentialité – MegaCare",
  description:
    "Découvrez comment MegaCare collecte, utilise et protège vos données personnelles de santé.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              La confidentialité de vos données, et notamment de vos données de
              santé, est au cœur de notre engagement. Découvrez comment MegaCare
              les protège.
            </p>
          </div>

          {/* Highlight banner */}
          <div className="flex items-start gap-4 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-5 mb-10">
            <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900 flex items-center justify-center shrink-0">
              ...
              >
                <path
                  ...
                  d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.955 11.955 0 01.17 11.89c.014.2.025.4.025.61 0 5.522 4.02 10.29 9.47 11.233C15.22 22.47 19.5 17.866 19.5 12c0-.2.01-.4.025-.61A11.955 11.955 0 0116.4 6a11.95 11.95 0 01-2.4-1.286z"
                />
              </svg>
            </div>
            <div>
              <p className="font-semibold text-emerald-800 dark:text-emerald-300 mb-1">
                Vos données de santé ne sont jamais vendues
              </p>
              <p className="text-sm text-emerald-700 dark:text-emerald-400">
                MegaCare s'engage à ne jamais vendre, louer ni partager vos
                données personnelles ou de santé à des fins commerciales. Vos
                informations médicales n'appartiennent qu'à vous.
              </p>
            </div>
          </div>
          ...
          <div className="mt-14 p-6 bg-primary/5 border border-primary/20 rounded-2xl text-center">
            <p className="text-muted-foreground mb-4">
              ...
              pour connaître les règles d'utilisation de la plateforme.
            </p>
            <Link
              href="/register"
