...
export const metadata = {
  title: "Conditions d'utilisation – MegaCare",
  description:
    "Lisez les conditions générales d'utilisation de la plateforme MegaCare avant de créer votre compte.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Veuillez lire attentivement ces conditions avant d'utiliser la
              plateforme MegaCare. En vous inscrivant, vous acceptez l'ensemble
              de ces termes.
            </p>
          </div>
